onload = () => {
  ...
  messageDisplay.innerText = "One click equals to one heart and one heart equals to one drop of love for flower";
  messageDisplay.style.position = "fixed";
  messageDisplay.style.bottom = "60px";
  messageDisplay.style.right = "10px";
  messageDisplay.style.background = "transparent";
  ...
  messageDisplay.style.boxShadow = "0 4px 6px rgba(0, 0, 0, 0.1)";
